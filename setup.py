...
terminal_client_ENABLED = DEFAULT and not WIN32
...
if WIN32:
    ...
    if modules_ENABLED:
        ...
        if client_ENABLED and opengl_ENABLED:
            add_packages("xpra.client.win32.opengl")
...
toggle_packages(proxy_ENABLED, "xpra.server.session_registry")
